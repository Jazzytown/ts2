...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("lime", "orange");
  box2.display("lime", "orange");
  box3.display("lime", "orange");
  box4.display("lime", "orange");
  box5.display("lime", "orange");
  box6.display("lime", "orange");
  box7.display("lime", "orange");
  box8.display("lime", "orange");
  box9.display("lime", "orange");
  box10.display("lime", "orange");
  box11.display("lime", "orange");
  box12.display("lime", "orange");
  box13.display("orange", "orange");
  box14.display("orange", "orange");
  box15.display("orange", "orange");
  ...
  stand1.display();
  stand2.display();
  ball.display("orange", "lime");
  textSize(55);
  fill("lime");
  text("Im           the                Bad                  guy         ", 150, 385)
  fill("lime");
  textSize(20);
